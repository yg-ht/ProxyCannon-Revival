...
def main():
    ...
    # Allow local connections to RFC1918 (1 of 4)
    ...
    # Allow local connections to RFC1918 (2 of 4)
    ...
    # Allow local connections to RFC1918 (3 of 4)
    #run_sys_cmd("Allowing local connections to RFC1918 (3 of 3)", True, localcmdsudoprefix +
    #            "iptables -w 2 -t nat -I POSTROUTING -d 0.0/8 -j RETURN")
